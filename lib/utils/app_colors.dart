...
const Color defaultLoaderColor = Color.fromRGBO(255,255,255,1);
const Color textPrimaryColor = Color.fromRGBO(33,33,33,1);
const Color dividerColor = Color.fromRGBO(189,189,189,1);
final Color textIconColorGray = Colors.grey.shade600;
final Color cardColorGray = Colors.grey.shade50;
